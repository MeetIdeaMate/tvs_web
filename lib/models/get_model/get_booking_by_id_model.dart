...
GetBookingDetailsByIdModel getBookingDetailsByIdModelFromJson(String str) =>
    GetBookingDetailsByIdModel.fromJson(json.decode(str));

String getBookingDetailsByIdModelToJson(GetBookingDetailsByIdModel data) =>
...
class GetBookingDetailsByIdModel {
  ...
  factory GetBookingDetailsByIdModel.fromJson(Map<String, dynamic> json) =>
      GetBookingDetailsByIdModel(
