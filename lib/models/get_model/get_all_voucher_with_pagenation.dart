...
GetAllVoucherWithPagenationModel getAllVoucherWithPagenationModelFromJson(
        String str) =>
    GetAllVoucherWithPagenationModel.fromJson(json.decode(str));

String getAllVoucherWithPagenationModelToJson(
        GetAllVoucherWithPagenationModel data) =>
...
class GetAllVoucherWithPagenationModel {
  ...
  factory GetAllVoucherWithPagenationModel.fromJson(
          Map<String, dynamic> json) =>
      GetAllVoucherWithPagenationModel(
        content: json["content"] == null
            ? []
            : List<VoucherDetails>.from(
                json["content"]!.map((x) => VoucherDetails.fromJson(x))),
        empty: json["empty"],
        first: json["first"],
        last: json["last"],
        number: json["number"],
...
class VoucherDetails {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "voucherDate":
            "${voucherDate!.year.toString().padLeft(4, '0')}-${voucherDate!.month.toString().padLeft(2, '0')}-${voucherDate!.day.toString().padLeft(2, '0')}",
        "voucherId": voucherId,
      };
}
